...
namespace LINQsql_1
{
    ...
    {
        private const string FileOrServerOrConnection = @"Data Source=(LocalDB)\MSSQLLocalDB;Initial Catalog=Northwind;Integrated Security=True";
        DataContext db;
        public Form1()
        {
            InitializeComponent();
            
            db = new DataContext(FileOrServerOrConnection);
        }
